...
export const fieldDefinitions = Object.freeze({
  ...
  predictionPeriod: { id: "predictionPeriod", name: "Periodo de predicción", type: "select", label: "Periodo a explorar", options: ["Próximos 7 días", "Próximo mes", "Próximos 3 meses", "Próximos 6 meses"] },
  moonPhase: { id: "moonPhase", name: "Fase lunar", type: "select", label: "Fase lunar", options: ["General", "Luna nueva", "Creciente", "Luna llena", "Menguante"] },
  twoCardLayout: { id: "twoCardLayout", name: "Configuración de dos cartas", type: "select", label: "Cómo leer las dos cartas", options: ["Situación y consejo", "Tú y la otra persona", "A favor y en contra", "Problema y solución", "Presente y evolución", "Visible y oculto"] },
  yesNoCardCount: { id: "yesNoCardCount", name: "Cantidad para sí o no", type: "select", label: "Número de cartas", options: ["1 carta", "3 cartas"] },
